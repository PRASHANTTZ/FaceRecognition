...
public class svm_scale
{
	...
	private void output_target(double value , BufferedWriter bw)
	{
		if(y_scaling)
		{
			if(value == y_min)
	...
	private void output(int index, double value , BufferedWriter bw)
	{
		...
		if(value != 0)
		{
			try {
				...
				bw.write(index + ":" + df.format(value) + " ");
	...
	public void run(String []argv  , String outputfile) throws IOException
	{
		int i,index;
